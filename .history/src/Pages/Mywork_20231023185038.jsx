...
function Mywork() {
  return (
    <div class="dark md:bg-black ">
      ...
      <div>
        {" "}
        <div className="container mx-auto mt-6 dark md:bg-black">
          <h2 className="text-3xl font-bold mb-2 ">Work Experience</h2>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 dark dark:bg-black">
            <div className="dark md:bg-black">
              ...
              />
              <div className="dark:text-slate-400 ring-1 ring-slate-900 max-w-2xl p-8 dark dar:bg-black">
