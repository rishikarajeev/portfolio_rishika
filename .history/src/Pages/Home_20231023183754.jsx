...
function Home() {
  return (
    ...
    <Nav />
    <div class="grid grid-cols-1 md:grid-cols-2 h-screen dark md:bg-black gap-4  ">
      <div class="grid grid-cols-2 justify-center items-center m-8 ">
        <div class="dark:bg-black rounded-lg   mb-4 shadow-xl  ">
          <div class=" md:grid md:grid-rows-2 md:gap-4 ">
            <div class="">
              <img
                class="h-48 w-full object-cover md:h-full rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2"
                src={img}
