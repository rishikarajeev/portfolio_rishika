...
function Home() {
  return (
    ...
    <Nav />
    <div class="grid grid-cols-2 h-screen dark md:bg-black  ">
      <div class="grid grid-cols-3 justify-center items-center m-8 ">
      ...
      <div class="divide-y divide-dashed dark md:bg-black m-8">
